...
const unsigned long TIMEOUT_DURATION = 200;
// -----------------------------------------------------
...
//    float angular_z = cmd_vel_msg.angular.z;
    ...
    double left_wheel_velocity = cmd_vel_msg.linear.x - (cmd_vel_msg.angular.z * 0.42 / 2.0);
    double right_wheel_velocity = cmd_vel_msg.linear.x + (cmd_vel_msg.angular.z * 0.42 / 2.0);

    int left_pwm = map_pwm(left_wheel_velocity, -1.5, 1.5, 100, 255);
    int right_pwm = map_pwm(right_wheel_velocity, -1.5, 1.5, 100, 255);
